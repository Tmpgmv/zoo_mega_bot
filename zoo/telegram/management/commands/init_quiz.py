...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Вопрос 1
        q1 = Question.objects.create(text="Какое время суток тебе ближе?", order=1)
        ...
        # Вопрос 2
        q2 = Question.objects.create(text="Что ты ценишь в людях больше всего?", order=2)
        ...
        # Вопрос 3
        q3 = Question.objects.create(text="Какая стихия тебе ближе?", order=3)
        ...
        # Вопрос 4
        q4 = Question.objects.create(text="Какое место ты бы выбрал для отдыха?", order=4)
